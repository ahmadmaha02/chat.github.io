	...
	<body>
		...
		<div class="container">
			...
			<div class="content">
				...
				<br>
				<form method="POST" action="controller/chatController.php">
					<div class="container">
						<div class="form-row">
							...
							<div class="col-md-12">
								<textarea class="form-control" name="message" required placeholder="tulis pesan"></textarea><br>
							</div>

							<div class="col-md-10">
								<button class="send" name="send">
									kirim pesan <i class="fa fa-comment"></i>
								</button>
							</div>

							<div class="col-md-2">
								<a href="controller/logout.php" class="btn btn-info btn-block" style="color: #FFF;">
									<i class="fa fa-frown"></i> log out
								</a>
							</div>
